        ...
        for payslip in self:
            if payslip.move_id:
                ...
                line_vals = {'branch_id': payslip.employee_id.branch_id.id or False,
                            'analytic_tag_ids': [(6, 0, self.contract_id.analytic_tag_ids.ids)] or False}
                if self.contract_id.analytic_account_id:
                    line_vals.update({'analytic_account_id': self.contract_id.analytic_account_id.id or False})
